...
const PurchesListEditMobile = ({ onSubmited }: { onSubmited: () => void; }) => {
    // const p: productType;
    ...
    const handlePushPurchaseInfo = (dt: purchaseDetailType) => {
        ...
        // ------------
        dispatch(purchaseEditSlice.actions.pushPurchase({
            purchaseDetail: dt
        }));
    }
    useEffect(() => {
                            ...
                            <tr className='border'>
                                ...
                                <td className='text-right border px-2 py-1'>
                                    <DatePicker value={purchaseMt?.pur_date ? new Date(purchaseMt?.pur_date) : undefined} onSelect={(date) => {
                                        dispatch(purchaseEditSlice.actions.handleSetPur_date(date?.toISOString()))
                                    }} />
                                </td>
                            </tr>
                            <tr className='border'>
...
export default PurchesListEditMobile
