...
const PurchesHandlerMobile = ({ onNext, onSubmited }: { onNext: (incre: number) => void; onSubmited: () => void; }) => {
    // const p: productType;
    ...
    const totalSumBy = () => _.sumBy(purchaseDts, (purchase) => Number(purchase.qty) * Number(purchase.unit_price)) || 0;
