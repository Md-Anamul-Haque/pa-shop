...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeftIcon className={cn("h-4 w-4", props?.className)} style={props?.style} />,
        IconRight: ({ ...props }) => <ChevronRightIcon className={cn("h-4 w-4", props?.className)} style={props?.style} />,
      }}
      {...props}
    />
  )
