...
import * as src_api_sales_return__slug__route_ts from './sales-return/[slug]/route';
import * as src_api_sales_return_route_ts from './sales-return/route';
...
router.get('/sales-return/:slug', src_api_sales_return__slug__route_ts.GET);
router.put('/sales-return/:slug', src_api_sales_return__slug__route_ts.PUT);
router.get('/sales-return', src_api_sales_return_route_ts.GET);
router.post('/sales-return', src_api_sales_return_route_ts.POST);
